...
<details>
  ...
  * Data para entrega no prazo regular: `26/01/2024 14:00`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-032-b-project-job-insights.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-032-b-project-job-insights`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-032-b-project-job-insights/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-032-b-project-job-insights/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH32-B&template=betrybe/sd-0x-project-job-insights)
...
- O método read deve ler o csv e armazenar os dados em `self.job_list`, que será lista dicionários, onde as chaves são os cabeçalhos de cada coluna e os valores correspondem a cada linha. 
